                    ...
                    <div className="space-y-8">
                        ...
                        <Reveal>
                            <div className="flex items-center gap-6">
                             {/* <a href="#projects" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-rose-600 transition duration-300 ease-out border-2 border-rose-500 rounded-full shadow-md group">
                                    ...
                                    <span className="absolute flex items-center justify-center w-full h-full text-rose-500 transition-all duration-300 transform group-hover:translate-x-full ease">Projects</span>
                                    <span className="relative invisible">Projects</span>
                                </a> */}
